      ...
      >
        <Box mt={isNotSmall ? 16 : 0}>
          ...
          <Text fontSize={isNotSmall ? "xl" : "m" } color='white'>
            {" "}
            Helpr is a platform that aims to push people to help and learn from each other. By rewarding members who help others, Tutorize uses teaching as its currency! Help others to recieve tokens you can then redeem to recieve help from others
            {" "}
          </Text>
